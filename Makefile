...
LIBS                 := $(PARSER_LIB) $(CORE_LIB)
BONUS_LIBS           := $(BONUS_PARSER_LIB) $(CORE_LIB)

# Library Linking
LIB_PATH             := -L$(PARSER_DIR) -L$(CORE_DIR)  -L/usr/local/lib
LIB_FLAGS            := -lparser -lcore
BONUS_LIB_FLAGS      := -lbonusparser  -lcore
